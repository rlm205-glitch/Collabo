...
export function EditProjectModal({ project, onClose, onSave }: EditProjectModalProps) {
  ...
  const [preferredSkills, setPreferredSkills] = useState(project.preferredSkills.join(', '));
  const [timeCommitment, setTimeCommitment] = useState(project.timeCommitment);
  const [contactMethod, setContactMethod] = useState(project.contactMethod);
